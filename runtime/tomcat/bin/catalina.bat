...
rem --added by Loc Nguyen--
set JAVA_OPTS=%JAVA_OPTS% -server -Xms512m -Xmx768m
rem --advanced--
rem set JAVA_OPTS=%JAVA_OPTS% -server -Xms1500m -Xmx1500m

if not exist "%CATALINA_BASE%\conf\logging.properties" goto noJuli
set JAVA_OPTS=%JAVA_OPTS% -server -Djava.util.logging.manager=org.apache.juli.ClassLoaderLogManager -Djava.util.logging.config.file="%CATALINA_BASE%\conf\logging.properties"
:noJuli
