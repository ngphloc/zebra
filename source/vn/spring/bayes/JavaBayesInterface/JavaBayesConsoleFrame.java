...
public class JavaBayesConsoleFrame extends Frame {
	...
	void PosteriorExpectation_Action() {
	    CheckboxMenuItem active_item =
	            update_checkbox_menu(menu2, posterior_expectation, posterior_marginal);
	...
	void PosteriorMarginal_Action() {
  	    CheckboxMenuItem active_item =
	            update_checkbox_menu(menu2, posterior_marginal, posterior_expectation);
        if ( active_item == posterior_expectation )
                jb.posterior_expectation_action();
        else
                jb.posterior_marginal_action();
	...
	void AlgorithmVariableElimination_Action() {
	    CheckboxMenuItem active_item =
	        update_checkbox_menu(menu7, algorithm_variable_elimination, algorithm_bucket_tree);
	...
	void AlgorithmBucketTree_Action() {
	    CheckboxMenuItem active_item =
	        update_checkbox_menu(menu7, algorithm_bucket_tree, algorithm_variable_elimination);
     ...
     */
	public JavaBayesConsoleFrame(JavaBayesI java_bayes,  String title) {
        jb = java_bayes;
        setTitle(title);
     ...
     * Constructor for JavaBayesConsoleFrame.
     */
	public JavaBayesConsoleFrame(JavaBayesI jb) {
	    this(jb, ((String)null));
	}
