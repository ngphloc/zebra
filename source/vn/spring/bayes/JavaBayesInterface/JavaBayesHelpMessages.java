 ...
 * @author Fabio G. Cozman, modified by Loc Nguyen 
...
public class JavaBayesHelpMessages {
    ...
    static JavaBayesI jb;

    // Constructor
    public static void insert(JavaBayesI java_bayes) {
        jb = java_bayes;
    }
    ...
    static final String version_number_message = "Version 0.347";

    public static final String about_message = new String(
        "JavaBayes " + version_number_message + "\n" +
        "Copyright 1996 - 1997 Carnegie Mellon University \n" +
        "Copyright 1998 - 2001 Fabio Gagliardi Cozman \n" +
        "<fgcozman@usp.br>\n" +
   ...
   public static final String start_scratch_message = new String(
        "JavaBayes starts in Move mode.\n" +
        "To create a network from scratch, click on the Create button\n" +
        "in the JavaBayes Editor window.  To load a network from a\n" +
        "file, use the File->Open menu of this JavaBayes Console window.\n\n");

   public static final String start_file_message = new String(
        "JavaBayes starts in Move mode.\n" +
        "To create nodes and arrows, click on the Create button\n" +
        "in the JavaBayes Editor window.\n");
