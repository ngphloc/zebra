...
public class InterchangeFormat {
    InputStream istream;
    vn.spring.bayes.Parsers.XMLBIFv03.XMLBIFv03 xml_bif03;
    vn.spring.bayes.Parsers.XMLBIFv02.XMLBIFv02 xml_bif02;
    vn.spring.bayes.Parsers.BIFv015.BIFv015 bif015;
    vn.spring.bayes.Parsers.BIFv01.BIFv01 bif01;
    ...
    public void CompilationUnit() throws IFException {
        ...
        xml_bif03 = new vn.spring.bayes.Parsers.XMLBIFv03.XMLBIFv03(istream);
        try {
        ...
        xml_bif02 = new vn.spring.bayes.Parsers.XMLBIFv02.XMLBIFv02(istream);
        try {
            ...
            error_messages.append("Input stream reset!\n");
        // Note that the following lines are within an enclosing catch block.
        bif015 = new vn.spring.bayes.Parsers.BIFv015.BIFv015(istream);
        try {
            ...
            error_messages.append("Input stream reset!\n");
        // Note that the following lines are within an enclosing catch block.
        bif01 = new vn.spring.bayes.Parsers.BIFv01.BIFv01(istream);
        try {
