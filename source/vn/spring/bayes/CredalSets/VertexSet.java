...
public class VertexSet
   ...
   */
  public VertexSet(BayesNet b_n, ProbabilityVariable pvs[],
                   double v[], Vector prop, double ep[][]) {
  ...
  /**
   * Constructor for a VertexQBProbabilityFunction from a 
   * ProbabilityFunction object and new values.
   */
  ...
  /**
   * Put together all the values for the possible vertices of
   * credal set and create an auxiliary variable to indicate
   * which vertex to consider
   * There are three things to do:
   * 1) Create an auxiliary_variable with correct values.
   * 2) Combine the values into a new array.
   * 3) Insert the auxiliary_variable into the variables array.
   */
  public VertexSet prepare_auxiliary_variable(BayesNet transformed_bn) {
    ...
    if (auxiliary_variable != null) return(this);
  ...
  create_auxiliary_variable(BayesNet transformed_bn) {
    ...
    ProbabilityVariable auxv =
        new ProbabilityVariable(transformed_bn, auxiliary_variable_name,
  ...
  /**
   * Evaluate a function given a list of pairs (Variable Value)
   * which specifies a value of the function, and the index
   * of the extreme distribution to consider.
   */
  ...
  /**
   * Produce the centroid of all extreme distributions and
   * insert it into the values of the distribution.
   */
