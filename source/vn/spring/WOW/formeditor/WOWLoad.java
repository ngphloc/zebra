...
/**
 * WOWLoad.java 1.0, August 30, 2008.
 *
...
public class WOWLoad {
    ...
    public WOWLoad(URL base) {
        ...
        try {
            ...
            frame = new JDialog((JFrame) null, "Load WOW! application", true);
    ...
    public void fillList() {
        try {
            URL url = new URL("http://" + home.getHost() + ":" + home.getPort() + dirname +
                    "/servlet/authorservlets.ListFiles?extention=" + ".wow" + "&userName=" +
                    FormEditor.userName);
            ...
            do {
                sFile = in.readLine();
            //    System.out.println("input: " + sFile);
