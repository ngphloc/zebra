...
public class FromMoodleXML {
	...
	protected MoodleXML moodleXML;
	
	protected WriteWOW3 writeWOW3;
	

	public FromMoodleXML() {}
	...
	public boolean convert(String inputFile, String outputFile) {
		...
		// parse file
		parser.setContentHandler(moodleXML);
		parser.setErrorHandler(moodleXML);
		...
		if ( writeWOW3.writeWOWFile ( moodleXML.getFileQuestion ( ) , outputFile ) ) {
			return true;
		} else {
			return false;
		}
