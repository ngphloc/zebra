...
public class FromHotPotatoesv6 {
	...
	protected HotPotatoesv6 hotPotatoesv6;
	
	protected WriteWOW3 writeWOW3;
	

	public FromHotPotatoesv6() {}
	...
	public boolean convert(String inputFile, String outputFile) {
		...
		// variables
		hotPotatoesv6 = new HotPotatoesv6 ( );
		...
		// parse file
		parser.setContentHandler(hotPotatoesv6);
		parser.setErrorHandler(hotPotatoesv6);
		...
		if ( writeWOW3.writeWOWFile ( hotPotatoesv6.getFileQuestion ( ) , outputFile ) ) {
			return true;
		} else {
			return false;
		}
