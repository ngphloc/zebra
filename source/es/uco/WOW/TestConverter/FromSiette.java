...
public class FromSiette {
	...
	public boolean convert(String inputFile, String outputFile) {
		...
		// parse file
		parser.setContentHandler(siette);
		parser.setErrorHandler(siette);
		...
		if ( writeWOW3.writeWOWFile ( siette.getFileQuestion ( ) , outputFile ) ) {
			return true;
		} else {
			return false;
		}
