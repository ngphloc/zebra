...
public class FromQti20 {
	...
	public boolean convert(String inputFile, String outputFile) {
		...
		// parse file
		parser.setContentHandler(qti20);
		parser.setErrorHandler(qti20);
		...
		if ( writeWOW3.writeWOWFile ( qti20.getFileQuestion ( ) , outputFile ) ) {
			return true;
		} else {
			return false;
		}
